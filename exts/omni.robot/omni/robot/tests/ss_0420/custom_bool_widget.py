...
class CustomBoolWidget(CustomBaseWidget):
    ...
    def _restore_default(self):
        ...
        if self.revert_img.enabled:
            self.bool_image.checked = self.default_val
    ...
    def _on_value_changed(self):
        ...
        self.revert_img.enabled = self.default_val != self.bool_image.checked
        ...
        with ui.HStack():
            with ui.VStack():
                ...
                self.bool_image = ui.Image(
                    name="checked" if self.default_val else "unchecked",
                    fill_policy=ui.FillPolicy.PRESERVE_ASPECT_FIT,
                    height=16, width=16, checked=self.default_val
                )
