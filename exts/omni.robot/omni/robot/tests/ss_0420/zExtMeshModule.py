...
class zExtMesh(ctypes.Structure):
    ...
    def getFaceCount(self):
        faceCount = (ctypes.c_int * (self.fCount))()
        ext_meshUtil_getMeshFaceCount(ctypes.byref(self), faceCount)
        return faceCount

    def getFaceConnect(self):
        faceConnect = (ctypes.c_int * (self.fCount))()
        ext_meshUtil_getMeshFaceConnect(ctypes.byref(self), faceConnect)
        return faceConnect
